...
describe "/catalog/_show_partials/_default.html.erb" do
  ...
  before(:each) do
    @fname_1 = blacklight_config[:show_fields][:field_names].last
    @fname_2 = "solr_field_not_in_initializer"
    @fname_3 = blacklight_config[:show_fields][:field_names][2]
    @fname_4 = blacklight_config[:show_fields][:field_names][0]
    ...
    @flabel_1 = blacklight_config[:show_fields][:labels][@fname_1]
    @flabel_3 = blacklight_config[:show_fields][:labels][@fname_3]
    @flabel_4 = blacklight_config[:show_fields][:labels][@fname_4]
