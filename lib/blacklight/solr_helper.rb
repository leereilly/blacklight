...
module Blacklight::SolrHelper
 ...
 # returns a params hash for searching solr.
  ...
  def solr_search_params(user_params = params || {})
    ...
    def add_sorting_paging_to_solr(solr_parameters, user_params)
      ...
      if solr_parameters[:sort].blank?
        ...
        solr_parameters[:sort] = default_sort_field.sort if default_sort_field
      end
    ...
    def add_facetting_to_solr(solr_parameters, user_params)
      ...
      blacklight_config.facets.each do |field_name, facet|
  ...
  def facet_limit_for(facet_field)
    facet = blacklight_config.facets[facet_field]
